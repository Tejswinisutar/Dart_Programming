...
int main() {                                                                       // Entry Point Function
  ...
  customer1.getemployeeinformation();                                           // Method Calling
  customer1.setemployeeinformation();                                          //Method Calling
  ...
  employee1.getemployeeinformation();                                           // Method calling
  employee1.setemployeeinformation();                                          // Method calling
